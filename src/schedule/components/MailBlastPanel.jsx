      ...
      <div className="newsletter-builder-grid">
        ...
        <section className="admin-panel newsletter-preview-panel" data-bbm-tour="mail-preview">
          ...
          <div className="newsletter-preview-frame">
            ...
            <div className="newsletter-preview-footer">You’re receiving this because you joined the Black Bridge Mindset community.<br />Keep building. Keep crossing. <a href="/api/schedule/newsletter/unsubscribe">Unsubscribe</a></div>
          </div>
